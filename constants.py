...
STATE_START = 1
STATE_STOP = 2
STATE_INTERIM_UPDATE = 3
STATE_ACCOUNTING_ON = 7
STATE_ACCOUNTING_OFF = 8
STATE_TUNNEL_START = 9
STATE_TUNNEL_STOP = 10
STATE_TUNNEL_LINK_START = 12
STATE_TUNNEL_LINK_STOP = 13
...
STATE_STEP_REQ_START = 1
STATE_STEP_ACK_IDENTITY = 2
STATE_STEP_ACK_MD5_CHALLENGE = 3
STATE_STEP_INIT_DONE = 4
